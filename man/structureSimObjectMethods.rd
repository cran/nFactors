...
% Please edit documentation in R/structureSimObjectMethods.r
\name{summary.structureSim}
...
\usage{
\method{summary}{structureSim}(object, index = c(1:15),
  eigenSelect = NULL, ...)
...
\item{...}{variable: additionnal parameters to give to the \code{boxplot},
...
\item{vLine}{character: color of the vertical indicator line of the initial
