...
% Please edit documentation in R/corFA.r
\name{corFA}
\alias{corFA}
...
\arguments{
\item{R}{An integer matrix or a data.frame of correlations}

\item{method}{A character vector: inversion method}
}
\value{
...
\author{
Gilles Raiche, Universite du Quebec a Montreal (\email{raiche.gilles@uqam.ca})
}
\keyword{manip}
